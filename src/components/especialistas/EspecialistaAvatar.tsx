...
import type { EspecialistaId } from "../../../shared/especialistas";

/**
 * Avatares SVG inline dos 5 especialistas virtuais.
 *
 * Preservado do commit 64cbf60 — ilustração feita à mão, uma por especialista.
...
const AVATARS: Record<EspecialistaId, (size: number) => ReactElement> = {
  victor: (size) => (
    <svg viewBox="0 0 96 96" width={size} height={size} role="img" aria-label="Dr. Victor">
      ...
      {/* Cabelo */}
      <path
        d="M30 38 Q 32 24, 48 22 Q 64 24, 66 38 Q 60 32, 48 32 Q 36 32, 30 38 Z"
        fill={HAIR_DARK}
      />
      {/* Sobrancelhas — sérias */}
  ...
  ana: (size) => (
    <svg viewBox="0 0 96 96" width={size} height={size} role="img" aria-label="Dra. Ana">
      ...
      {/* Cabelo longo preso */}
      <path
        d="M28 38 Q 26 22, 48 20 Q 70 22, 68 38 Q 70 52, 64 58 L 62 50 Q 60 38, 48 36 Q 36 38, 34 50 L 32 58 Q 26 52, 28 38 Z"
        fill={HAIR_DARK}
      />
  ...
  cris: (size) => (
    <svg viewBox="0 0 96 96" width={size} height={size} role="img" aria-label="Dra. Cris">
      ...
      <path
        d="M28 36 Q 30 20, 48 20 Q 66 20, 68 36 Q 64 28, 56 30 Q 48 24, 40 30 Q 32 28, 28 36 Z"
        fill={HAIR_LIGHT}
      />
      {/* Sobrancelhas alegres */}
      <path
        d="M38 41 Q 41 39, 44 41"
        stroke={HAIR_LIGHT}
        strokeWidth="1.5"
        fill="none"
        strokeLinecap="round"
  ...
  bruno: (size) => (
    <svg viewBox="0 0 96 96" width={size} height={size} role="img" aria-label="Dr. Bruno">
      ...
      {/* Cabelo raspado */}
      <path
        d="M30 38 Q 32 28, 48 26 Q 64 28, 66 38 Q 60 34, 48 34 Q 36 34, 30 38 Z"
        fill={HAIR_DARK}
      />
  ...
  lucia: (size) => (
    <svg viewBox="0 0 96 96" width={size} height={size} role="img" aria-label="Dra. Lúcia">
      ...
      <path
        d="M14 96 C 18 70, 30 64, 48 64 C 66 64, 78 70, 82 96 Z"
        fill="url(#l-coat)"
        stroke="#C7D2FE"
        strokeWidth="1"
      />
      ...
      <path
        d="M28 38 Q 28 22, 48 20 Q 68 22, 68 38 Q 66 32, 58 30 Q 48 28, 38 30 Q 30 32, 28 38 Z"
        fill={HAIR_LIGHT}
      />
      {/* Sobrancelhas suaves */}
      <path
        d="M38 41 Q 41 40, 44 41"
        stroke={HAIR_LIGHT}
        strokeWidth="1.4"
        fill="none"
        strokeLinecap="round"
...
export function EspecialistaAvatar({ especialistaId, size = 64, className }: Props) {
  const renderer = AVATARS[especialistaId];
...
export default EspecialistaAvatar;
