        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          {sectors.map((s) => (
            <button
              ...
              className="group relative bg-white border border-border rounded-[2.5rem] p-10 text-left transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/5 overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

              <div
                className={`relative h-16 w-16 rounded-2xl ${s.bg} flex items-center justify-center ${s.color} mb-8 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3 shadow-sm`}
              >
